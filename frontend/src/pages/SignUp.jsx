  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div className="glass mx-auto w-full h-auto px-6 flex flex-col gap-6 items-center py-8 justify-center rounded-2xl">
          ...
          >
            ...
            <button
              className="gradient-bg w-full max-w-[640px] font-semibold text-xl py-3 px-8 rounded-full text-white mx-auto mt-6"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
